...
# state → (year, month) → sensor → crop_code → [count, frp_sum]
...
for state_name, year_month_data in sensor_crop_stats.items():
    ...
    with open(out_csv, 'w', newline='') as f:
        writer = csv.writer(f)
        writer.writerow(["State", "Year", "Month", "Sensor", "Crop Code", "Crop Name", "Fire Count", "FRP_SUM", "FRP_MEAN"])
