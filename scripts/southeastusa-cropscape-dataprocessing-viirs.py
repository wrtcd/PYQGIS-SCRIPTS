...
firepoints_root = Path(r"C:\Users\aeaturu\Desktop\WORK April 2025\Southeast USA Data Download\VIIRS NASA FIRMS\preppedfiredataset\monthlyfires")
output_dir = Path(r"C:\Users\aeaturu\Desktop\WORK April 2025\seusa-new\viirs\viirs-croptype-fc-frp")
...
for shp_path in firepoints_root.rglob("*.shp"):
    ...
    for code, (count, frp_sum) in stats.items():
        if code not in crop_code_to_name:
            continue  # 🚫 Skip any crop codes not in the 104 list
